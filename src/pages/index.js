...
const Wrapper = tw.div`
  flex items-center justify-center flex-col h-screen bg-black
`

const Main = tw.div`
  p-6 bg-black rounded-lg shadow-2xl
`
...
const Footer = tw.footer`
  mt-6 text-center text-white text-xs
`
